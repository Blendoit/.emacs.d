...
(custom-set-variables
 ...
 '(TeX-command-list
   '(("Latexmk" "latexmk -pdf -f -pdflatex=lualatex -shell-escape -interaction=nonstopmode --synctex=1 -outdir=%o" TeX-run-command nil t)
