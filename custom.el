...
(custom-set-variables
 ...
 '(erc-autojoin-channels-alist
   '(("freenode.net" "#linux" "#archlinux" "#emacs" "#bitcoin" "#latex" "#org-mode" "#python")))
 '(erc-modules
   '(autojoin button completion services spelling track hl-nicks netsplit fill match track readonly networks ring noncommands irccontrols move-to-prompt stamp menu list))
