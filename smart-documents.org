...
| \_ Darker shades                | /n/a/                           | lesser headers     |
...
Here are some fonts I discovered and enjoyed since I began learning
Emacs.

**** Serif

- Crimson Pro[fn::] :: ~variable-pitch~,
  default body text font
  - Inspired by Garamond
- Linux Libertine[fn::] :: ~variable-pitch~,
  default body text font
  - Inspired by Garamond
